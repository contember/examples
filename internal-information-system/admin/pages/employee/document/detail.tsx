	...
	return (
		<>
			...
			<DetailScope entity="Document(id=$id)">
				<SlotSources.Back>
					<LinkButton to="employee/document/list" size="small" className="mr-2" distinction="outlined">
				...
				<Stack direction="vertical" gap="xlarge">
					<Box className="box">
						<Stack direction="vertical">
							...
							<div className="box-item">
								<DisplayTextField field="accessLevel" label="Access level" labelPosition="labelLeft" />
							</div>
						</Stack>
					</Box>
				</Stack>
