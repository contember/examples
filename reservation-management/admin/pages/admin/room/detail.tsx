	...
	return (
		<>
			...
			<DetailScope entity="Room(id=$id)">
				<SlotSources.Back>
					<LinkButton to="admin/room/list" size="small" className="mr-2" distinction="outlined">
				...
				<SlotSources.Actions>
					<LinkButton to="admin/room/edit(id: $entity.id)">
						Edit room
					</LinkButton>
				</SlotSources.Actions>
					...
					<Box className="box">
						<div className="box-header">
							<Stack direction="horizontal" justify="space-between">
								...
								<LinkButton to="admin/booking/create">
									Create new booking
								</LinkButton>
							</Stack>
						</div>
						<DataGrid entities="Booking[room.id=$id]">
							<GenericCell shrunk canBeHidden={false}>
								<LinkButton to="admin/booking/detail(id: $entity.id)">
									Open detail
								</LinkButton>
							</GenericCell>
