...
export default () => {
	...
	const roleOptions = [{ value: 'assetManager', label: 'Asset manager' }, { value: 'maintenanceTechnician', label: 'Maintenance technician' }]
	const [role, setRole] = React.useState<string>('assetManager')
