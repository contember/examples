	...
	return (
		<>
			...
			<DetailScope entity="Lead(id=$id)">
				<SlotSources.Back>
					<LinkButton to="salesRepresentative/lead/list" size="small" className="mr-2" distinction="outlined">
				...
				<SlotSources.Actions>
					<LinkButton to="salesRepresentative/lead/edit(id: $entity.id)">
						Edit lead
					</LinkButton>
				</SlotSources.Actions>
					...
					<Box className="box">
						<div className="box-header">
							<Stack direction="horizontal" justify="space-between">
								...
								<LinkButton to="salesRepresentative/deal/create">
									Create new deal
								</LinkButton>
							</Stack>
						</div>
