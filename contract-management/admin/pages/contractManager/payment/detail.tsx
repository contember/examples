	...
	return (
		<>
			...
			<DetailScope entity="Payment(id=$id)">
				<SlotSources.Back>
					<LinkButton to="contractManager/payment/list" size="small" className="mr-2" distinction="outlined">
				...
				<SlotSources.Actions>
					<LinkButton to="contractManager/payment/edit(id: $entity.id)">
						Edit payment
					</LinkButton>
				</SlotSources.Actions>
				<Stack direction="vertical" gap="xlarge">
					<Box className="box">
						<Stack direction="vertical">
							...
							<div className="box-item">
								<DisplayTextField field="paymentMethod" label="Payment method" labelPosition="labelLeft" />
							</div>
							<div className="box-item">
