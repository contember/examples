	...
	return (
		<>
			...
			<DetailScope entity="Order(id=$id)">
				<SlotSources.Back>
					<LinkButton to="salesRepresentative/order/list" size="small" className="mr-2" distinction="outlined">
				...
				<SlotSources.Actions>
					<LinkButton to="salesRepresentative/order/edit(id: $entity.id)">
						Edit order
					</LinkButton>
				</SlotSources.Actions>
					...
					<Box className="box">
						...
						<DataGrid entities="OrderProduct[order.id=$id]">
							<GenericCell shrunk canBeHidden={false}>
								<LinkButton to="salesRepresentative/orderProduct/detail(id: $entity.id)">
									Open detail
								</LinkButton>
							</GenericCell>
